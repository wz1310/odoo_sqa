...
class WizardMutasiInventoryReport(models.TransientModel):
    _name = 'wizard.mutasi.inventory.report'
    ...
    product_classification_ids = fields.Many2many('master.classification.product', 'prod_class_id', 'wiz_mutasi_id')
