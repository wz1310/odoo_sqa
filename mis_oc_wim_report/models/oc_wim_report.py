...
class OCWIMReport(models.Model):
    _name = "oc.wim.report.realisasi"
    _description = "Realisasi OC WIM"
    _auto = False
    ...
    commitment_date_mask = fields.Datetime(string = 'Tgl DO')
                ...
                CREATE or REPLACE VIEW %s AS
                    SELECT  ROW_NUMBER() OVER (ORDER BY sj_no) AS "id", plant_id ,
                          ...
                          sales_name ,
                            ...
                            TO_TIMESTAMP(commitment_date_mask, 'YYYY-MM-DD HH24:MI:SS' ) at time zone 'UTC' AS "commitment_date_mask"  ,
                            notes ,
