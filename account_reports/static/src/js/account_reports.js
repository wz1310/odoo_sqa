...
var accountReportsWidget = AbstractAction.extend({
    ...
    custom_events: {
        'value_changed': function(ev) {
             ...
             self.report_options.analytic_account_group = ev.data.analytic_account_group;
    ...
    render_searchview_buttons: function() {
        ...
        if (this.report_options.analytic) {
            if (!this.M2MFilters) {
                ...
                if (this.report_options.analytic_account_group) {
                    fields['analytic_account_group'] = {
                        label: _t('Analytic Account Group'),
                        modelName: 'account.analytic.group',
                        value: this.report_options.analytic_account_group.map(Number),
                    };
                }
