...
class WizardReportTax10Report(models.TransientModel):
	_name = 'wizard.report.tax.10'
	_description = 'Wizard Report Tax 10'
	...
	def generate_excel(self, data):
		...
		worksheet.merge_range('B4:K4', 'PASAL 25',header_section)
