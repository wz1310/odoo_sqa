...
class WizardReportTax11Report(models.TransientModel):
	_name = 'wizard.report.tax.11'
	_description = 'Wizard Report Tax 11'
	...
	def generate_excel(self, data):
		...
		worksheet.merge_range('B4:K4', 'PASAL 4 (2)',header_section)
