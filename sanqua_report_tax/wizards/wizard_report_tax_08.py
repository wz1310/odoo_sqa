...
class WizardReportTax08Report(models.TransientModel):
	_name = 'wizard.report.tax.08'
	_description = 'Wizard Report Tax 08'
	...
	def generate_excel(self, data):
		...
		worksheet.merge_range('B4:K4', 'PASAL 22',header_section)
